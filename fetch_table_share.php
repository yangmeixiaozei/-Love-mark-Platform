...
<div>
	<table class="table-style2" width="96%" border="1">
		...
		<tbody>
			...
			$result = mysqli_query($conn, "SELECT * FROM share where UserPhone = '{$_SESSION['phone_number']}' ORDER BY date DESC");
			$count = 0;
			while ($row = mysqli_fetch_array($result)) {
				if ($count % 2 == 0){
					...
					<tr class="tr_line2">
						...
						<td style="width: 150px;"><a href="share_update.php?id=<?php echo $row[ 'ID']; ?> ">补充</a></td>
					</tr>
						<?php
				}
				else{
